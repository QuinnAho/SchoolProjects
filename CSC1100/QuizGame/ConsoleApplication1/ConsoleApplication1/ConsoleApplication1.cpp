...
int main() {
    ...
    int correctNum, guessedNum, questionCounter = 1;

    // Calculate the number of questions based on the size of the multipleChoice map
    int numQuestions = 10; // Since you have 10 questions
    ...
    //Acts as a key for all the correct choices.
    ...
    cout << "Choose the correct answer (1, 2, 3, or 4): ";
